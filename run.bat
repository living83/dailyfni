...
REM Start Cafe Macro server in a new window
start "DailyFNI - Cafe (port 8001)" /D "%ROOT_DIR%naver-cafe-macro\backend" cmd /k "%ROOT_DIR%naver-cafe-macro\.venv\Scripts\python.exe" main.py
