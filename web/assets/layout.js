...
(function () {
  ...
  function buildFooter() {
    ...
    return ''
      ...
      +         '<p class="text-[16px] tracking-widest uppercase text-zinc-500">사이트맵</p>'
      +         '<ul class="mt-4 space-y-2.5 text-[21px] text-zinc-300">'
      ...
      +         '<p class="text-[16px] tracking-widest uppercase text-zinc-500">법적 고지</p>'
      +         '<ul class="mt-4 space-y-2.5 text-[21px] text-zinc-300">'
